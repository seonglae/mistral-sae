...
This is just the default Mistral implementattion found here: https://github.com/mistralai/mistral-inference/blob/main/src/mistral_inference/transformer.py
Only real difference is this version checks for an SAE and replaces the activations if so.
